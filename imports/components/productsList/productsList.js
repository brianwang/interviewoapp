...
class ProductsListCtrl {
        ...
        this.helpers({
            products() {
                ...
                if (this.searchkey == "") {
                    ...
                    se = Meteor.call("products.search", this.searchkey);
                    // products = Products.find({}, {
                    //     sort: {
                    //         createdAt: -1
                    //     }
                    // });
                    se.then(function(err, result) {
                        console.log(result);
                        return result;
                    });
    ...
    search() {
        ...
        Meteor.call("products.search", this.searchkey).then(function(err, result) {
            return result;
        });
...
export default angular
    .module("productsList", [angularMeteor])
